...
const navItems = [
  ...
  { name: 'Catálogo', href: '/catalog', icon: List },
    ...
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr] bg-slate-100">
        ...
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex h-14 items-center justify-center border-b border-slate-700 px-4 lg:h-[60px] lg:px-6">
            <NavLink to="/" className="flex items-center gap-2 font-semibold text-white">
              <img src="https://horizons-cdn.hostinger.com/378de1a7-16dc-45cb-902e-80ce1d49a1f3/grupo-wg-TEmSq.png" alt="Grupo WG Almeida Logo" className="h-10 object-contain" />
            </NavLink>
          </div>
      ...
      <div className="flex flex-col">
        <header className="flex h-14 items-center justify-between gap-4 border-b bg-white px-4 lg:h-[60px] lg:px-6 md:hidden">
            <NavLink to="/" className="flex items-center gap-2 font-semibold mr-auto">
