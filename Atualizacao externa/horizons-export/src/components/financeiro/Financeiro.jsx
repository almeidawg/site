                            ...
                            <TableBody>
                                {lancamentos.map(lanc => (
                                    <TableRow key={lanc.id}>
                                        ...
                                        <TableCell><span className={`px-2 py-1 text-xs rounded-full ${lanc.type === 'income' ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-800'}`}>{lanc.type === 'income' ? 'Receita' : 'Despesa'}</span></TableCell>
        ...
        <>
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {loading ? <div className="col-span-4 flex justify-center p-8"><Loader2 className="animate-spin" /></div> : <>
