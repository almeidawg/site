        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                    ...
                    <div className="space-y-2"><Label>Projeto (Centro de Custo)</Label><Autocomplete table="obras" displayColumn="nome" onChange={(item) => handleAutocompleteChange('p_centro_custo', item)} placeholder="Todos"/></div>
                    <div className="space-y-2"><Label>Categoria</Label><Autocomplete table="fin_categories" displayColumn="name" onChange={(item) => handleAutocompleteChange('p_categoria_id', item)} placeholder="Todas"/></div>
                    <div className="space-y-2"><Label>Favorecido/Cliente</Label><Autocomplete table="parties" displayColumn="name" onChange={(item) => handleAutocompleteChange('p_favorecido', item)} placeholder="Todos"/></div>
                </div>
                <DialogFooter>
