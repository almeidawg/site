...
import React, { useState, useEffect, useCallback } from 'react';
    ...
    export default function RegistroPage() {
      ...
      const handleSelectChange = (key, value) => {
        setForm(prev => ({...prev, [key]: value === 'none' ? null : value})); // Handle 'none'
      };
      ...
      useEffect(() => {
        const fetchPropostasEObras = async () => {
          if (form.cliente?.id) {
            ...
            setPropostas([]);
            setObras([]);
            handleFormChange('proposta_id', 'none'); // Reset to 'none'
            handleFormChange('obra_id', 'none'); // Reset to 'none'
          }
        };
      ...
      const handleSave = async () => {
        if (!form.profissional?.id || !form.cliente?.id || form.categoria_id === 'none' || !form.data) { // Check for 'none'
        ...
        try {
          const payload = {
            ...
            proposta_id: form.proposta_id === 'none' ? null : form.proposta_id, // Ensure null for 'none'
            obra_id: form.obra_id === 'none' ? null : form.obra_id, // Ensure null for 'none'
            data: form.data,
            categoria_id: form.categoria_id === 'none' ? null : form.categoria_id, // Ensure null for 'none'
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleSelectChange('categoria_id', value)} value={form.categoria_id}>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleSelectChange('proposta_id', value)} value={form.proposta_id} disabled={!form.cliente}>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleSelectChange('obra_id', value)} value={form.obra_id} disabled={!form.cliente}>
