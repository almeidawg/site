      ...
      {isCartOpen && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-full max-w-md bg-gray-900/80 backdrop-blur-lg shadow-2xl flex flex-col"
              ...
              {cartItems.length === 0 ? (
                ...
                cartItems.map(item => (
                  <div key={item.variant.id} className="flex items-center gap-4 bg-white/5 p-3 rounded-lg">
                    <img alt={item.product.title} className="w-20 h-20 object-cover rounded-md" src="https://images.unsplash.com/photo-1646193186132-7976c1670e81" />
