        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200 ease-in-out group cursor-pointer">
            <div className="flex justify-between items-start mb-2">
                ...
                <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity ml-2">
                    <button
                        onClick={(e) => { e.stopPropagation(); onEditClient(card.cliente_id); }}
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent onClick={(e) => e.stopPropagation()}>
                            ...
                            <AlertDialogFooter>
                                ...
                                <AlertDialogAction onClick={handleDeleteCard} className="bg-red-600 hover:bg-red-700">Excluir</AlertDialogAction>
                            </AlertDialogFooter>
                        </AlertDialogContent>
                    </AlertDialog>
                </div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">{card.cliente_nome}</p>
