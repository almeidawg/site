        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                    ...
                    <div className="space-y-2"><Label>Projeto (Centro de Custo)</Label><Autocomplete table="entities" displayColumn="nome_razao_social" filterColumn="tipo" filterValue="cliente" value={selectedItems.p_centro_custo} onChange={(item) => handleAutocompleteChange('p_centro_custo', item)} placeholder="Todos"/></div>
