...
const PlaceholderPage = ({ title }) => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-3xl font-bold mb-2">Módulo de {safeTitle}</h1>
      <p className="text-muted-foreground max-w-md">
        Esta área está em construção e será o seu novo centro de gerenciamento para {safeTitle.toLowerCase()}.
      </p>
