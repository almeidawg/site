...
const TEMPLATE_PATHS_SOLICITACOES = '/templates/finance-solicitacoes-import.csv';
const EXPECTED_COLUMNS_SOLICITACOES = [
  'cliente_id',
  'descricao',
  'valor',
  'vencimento',
...
const Solicitacoes = () => {
  ...
  const handleFileImport = useCallback(
    async (event) => {
      ...
      const missing = validateCsvColumns(columns, EXPECTED_COLUMNS_SOLICITACOES);
      if (missing.length) {
        toast({
          variant: 'destructive',
      ...
      toast({
        ...
        description: `${rows.length} linhas prontas para importação.`,
      });
    },
    [toast]
  );
  ...
  return (
    <>
      <Helmet><title>Solicita├º├Áes de Pagamento - WG Almeida Gest├úo Financeira</title></Helmet>

      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Solicita├º├Áes de Pagamento</h1>
           ...
           <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href={TEMPLATE_PATHS_SOLICITACOES} download className="text-sm text-slate-600 hover:text-primary">
                Modelo CSV
              </a>
