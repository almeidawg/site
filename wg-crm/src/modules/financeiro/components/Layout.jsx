...
const Layout = ({ children, basePath = '/financeiro' }) => {
  ...
  const menuItems = [
    ...
    { path: '/projetos', icon: Building2, label: 'Projetos' },
    { path: '/lancamentos', icon: ArrowRightLeft, label: 'Lancamentos' },
    { path: '/solicitacoes', icon: FileText, label: 'Solicitacoes' },
    ...
    { path: '/cobrancas', icon: CreditCard, label: 'Cobrancas' },
  ];
      ...
      >
        <div className="p-4 flex items-center justify-center h-20 border-b wg-gradient text-white">
          <div>
            ...
            <p className="text-sm text-white/80">Gestao Financeira</p>
          </div>
        </div>
