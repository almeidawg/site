...
import ProjectItems from '@/modules/cronograma/components/ProjectItems';
import ScheduleView from '@/modules/cronograma/components/ScheduleView';
import ProjectTeam from '@/modules/cronograma/components/ProjectTeam';
import PdfExport from '@/modules/cronograma/components/PdfExport';
...
const ProjectDetail = () => {
    ...
    if (!project) {
        return <div className="p-8 text-center">
            ...
            <Button asChild><Link to={`${basePath}/projects`}><ArrowLeft className="mr-2 h-4 w-4" />Voltar aos projetos</Link></Button>
        </div>;
    }
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <Button variant="ghost" asChild className="mb-2 -ml-4">
                            <Link to={`${basePath}/projects`}><ArrowLeft className="mr-2 h-4 w-4" />Voltar</Link>
                        </Button>
