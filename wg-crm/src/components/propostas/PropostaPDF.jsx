...
const PropostaPDF = React.forwardRef(({ proposta, empresa }, ref) => {
  ...
  return (
    <div style={{ width: '210mm', minHeight: '297mm', position: 'relative', fontFamily: "'Bahnschrift', sans-serif" }} ref={ref}>
      <div className="bg-white text-black p-12" style={{ width: '100%', minHeight: '100%'}}>
        <div 
