...
const ContratoPDF = React.forwardRef(({ contrato }, ref) => {
  ...
  return (
    <div style={{ width: '210mm', height: '297mm', position: 'relative' }}>
      <div ref={ref} className="bg-white text-black" style={{ width: '100%', height: '100%', fontFamily: 'Arial, sans-serif' }}>
        <div 
          className="absolute inset-0 bg-contain bg-no-repeat bg-center" 
          style={{ backgroundImage: `url(${timbradoUrl})`, zIndex: 0 }}
        ></div>
        <div className="relative pt-[150px] px-16 pb-16 z-10 h-full flex flex-col">
